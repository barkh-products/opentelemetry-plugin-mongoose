    ...
    patchAggregateExec() {
        ...
        return (originalExec) => {
            return function exec() {
                ...
                span.setAttribute(enums_1.AttributeNames.DB_OPTIONS, utils_1.safeStringify(this.options));
                span.setAttribute(enums_1.AttributeNames.DB_AGGREGATE_PIPELINE, utils_1.safeStringify(this._pipeline));
    ...
    patchQueryExec() {
        ...
        return (originalExec) => {
            return function exec() {
                ...
                span.setAttribute(enums_1.AttributeNames.DB_STATEMENT, utils_1.safeStringify(this._conditions));
                span.setAttribute(enums_1.AttributeNames.DB_OPTIONS, utils_1.safeStringify(this.options));
                span.setAttribute(enums_1.AttributeNames.DB_UPDATE, utils_1.safeStringify(this._update));
